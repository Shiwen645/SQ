...
.joy-con.left {
  ...
  box-shadow: inset 3px -4px 10px #058ca5, inset 0px 5px 3px #6ad9ed;
...
.joy-con.right {
  ...
  box-shadow: inset -3px -4px 10px #d12621, inset 0px 5px 3px #fd877c;
}
...
.joystick-inner {
  ...
  box-shadow: inset 0px -4px 4px rgb(49, 49, 49),
    inset 0px 4px 12px rgb(124, 124, 124), inset 0px 4px 6px rgb(0, 0, 0);
  z-index: 3;
  position: relative;
}
...
.numpad-button {
  ...
  border-radius: 50%;
  border: 1px solid #2d2e33;
  box-shadow: inset -0.5px -0.5px 1.5px rgba(92, 92, 92, 0.5),
